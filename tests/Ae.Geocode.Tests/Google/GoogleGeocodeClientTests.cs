...
namespace Ae.Geocode.Tests.Google
{
    public sealed class GoogleGeocodeClientTests
    {
        ...
        [InlineData(3, "Leninsky District,Sevastopol,Crimean Peninsula")]
        [InlineData(4, "Southend-on-Sea,England,United Kingdom")]
        [InlineData(5, "Bystrinsky District,Kamchatka Krai,Russia")]
        [InlineData(6, "人和村,Xinyi Township,Nantou County,Taiwan,Taiwan Province")]
        ...
        [InlineData(33, "Stranocum,Ballymoney,Causeway Coast and Glens,Northern Ireland,Ireland,United Kingdom")]
